...
<html>
	<head>
		...
		<link href="ProfilReglages.css" rel="stylesheet" type="text/css" />
	...
	<body>
		...
		<div class="col-sm-3" style="text-align : center;"></div>
			<div class="col-sm-3" style="text-align : center;">
				<br>
				<input class="boutton3" Type="button" Value="Modifier sa photo de profil" Onclick="window.location.href='ProfilNewPP.php'">
				<br>
			</div>
			<div class="col-sm-3" style="text-align : center;">
				<br>
				<input class="boutton3"  Type="button" Value="Modifier sa photo de couverture" Onclick="window.location.href='ProfilNewPC.html'">
				<br>
			</div>
		</div>
		...
		<div class="row">
			...
			<div class="col-sm-3" style="text-align : center;">
				<br>
				<input class="boutton3" Type="button" Value="Modifier ses informations personelles" Onclick="window.location.href='ProfilNewPropos.php'">	
				<br>
			</div>
			<div class="col-sm-3" style="text-align : center;">
				<br>
				<input class="boutton3" Type="button" Value="Déconnexion" Onclick="window.location.href='Acceuil.php'">
				<br>
			</div>
		</div>
